...
/*   Updated: 2023/04/25 20:41:17 by slegaris         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char **argv)
{
    ...
    wall_time_used = (end_w.tv_sec - start_w.tv_sec) * 1000.0; // Convert to milliseconds
    wall_time_used += (end_w.tv_usec - start_w.tv_usec) / 1000.0; // Add microseconds
